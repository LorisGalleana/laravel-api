<aside class="text-bg-dark">
    <ul>
        <li class="pb-3"><a href="{{ route('admin.home') }}"><i class="fa-solid fa-house "></i> Home</a></li>
        <li class="pb-3"><a href="{{ route('admin.projects.index') }}"><i class="fa-solid fa-list "></i> Elenco progetti</a></li>
